# -*- coding: utf-8 -*-
"""
Created on Tue Aug 27 14:25:53 2024

@author: Esma
"""
#
"""
Meanshift,noktaları moda doğru kaydırarak veri noktalarını kümelere yenilemeli olarak atayan bir kümeleme algoritması
Mod en yüksek veri noktası yoğunluğu olarak tanımlanabilir.
Mod arama algoritması
"""
import cv2
import numpy as np
...
# takip için gerekli durdurma kriterrleri 
...
#çıktısı kameradan olusuyor kamera açıldıgında karşısında yüz olmazsa hata verir.
